    ...
    <body class="skin-blue" onload="init()">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <!-- Main content -->
                <section class="content" id="ContenidoIndicadores">
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="TipoProceso" onchange="cargarProcesoIndicadores()">
                                        ...
                                        <div class="box">
                                            <div class="nav-tabs-custom">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a href="#tab_1" data-toggle="tab" onclick="listarTablaIndicadores();">Indicadores</a></li>
                                                    <li><a href="#tab_2" data-toggle="tab">Administrar</a></li>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab_1">
                                                            ...
                                                            <div class="box-header">
                                                                <h3 class="box-title">Matriz de Indicadores de Gestión </h3>
                                                            </div><!-- /.box-header -->
                                                            <div class="box-body">
                                                                <table class="table table-bordered" id="tabla01" >
                                                                    <tr>
                                                                        <th style="width: 10px">#</th>
                                                                        <th style="width: 40px">Proceso</th>
                                                                        <th style="width: 40px">Codigo</th>
                                                                        <th style="width: 40px">Titulo</th>
                                                    ...
                                                    <div class="tab-pane" id="tab_2">
                                                            ...
                                                            <div class="box-body">
                                                                <form id="registroIndicadores">
                                                                    
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon">TITULO:</span>
                                                                            <input id="Nindicador" type="text" class="form-control" placeholder="Nombre Indicador" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon">CODIGO:</span>
                                                                            <input id="codigo" type="text" class="form-control" placeholder="Codigo" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon">UNIDAD:</span>
                                                                            <input id="unidad" type="text" class="form-control" placeholder="Unidad" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon">RESPONSABLE:</span>
                                                                            <input id="responsable" type="text" class="form-control" placeholder="Responsable" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer clearfix">
                                                                        <div onclick="AgregarIndicador();" class="btn btn-primary pull-left"><i class="fa fa-pencil"></i>Agregar</div>
                                                                    </div>
                                                                </form>
